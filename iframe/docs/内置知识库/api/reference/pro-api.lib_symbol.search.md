...
[Home](./pro-api.md) &gt; [LIB\_Symbol](./pro-api.lib_symbol.md) &gt; [search](./pro-api.lib_symbol.search.md)
...
Promise&lt;Array&lt;[ILIB\_SymbolSearchItem](./pro-api.ilib_symbolsearchitem.md)<!-- -->&gt;&gt;
