...
[Home](./pro-api.md) &gt; [SYS\_RightClickMenu](./pro-api.sys_rightclickmenu.md) &gt; [changeMenu](./pro-api.sys_rightclickmenu.changemenu.md)
...
如若需要注册新的右键菜单，需要传入完整的 [ISYS\_RightClickMenuItem](./pro-api.isys_rightclickmenuitem.md) 数据
