...
[Home](./pro-api.md) &gt; [SYS\_MessageBox](./pro-api.sys_messagebox.md) &gt; [showConfirmationMessage](./pro-api.sys_messagebox.showconfirmationmessage.md)

# SYS\_MessageBox.showConfirmationMessage() method

> 警告：此 API 现已弃用。
>
> 请使用 [SYS\_Dialog.showConfirmationMessage()](./pro-api.sys_dialog.showconfirmationmessage.md) 替代
