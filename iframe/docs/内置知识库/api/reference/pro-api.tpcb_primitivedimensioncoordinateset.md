[Home](./pro-api.md) &gt; [TPCB\_PrimitiveDimensionCoordinateSet](./pro-api.tpcb_primitivedimensioncoordinateset.md)
...
尺寸标注坐标集存在以下三种 [尺寸标注类型](./pro-api.epcb_primitivedimensiontype.md)<!-- -->：
