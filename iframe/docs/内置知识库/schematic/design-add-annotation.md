...
![图 1](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172124.jpg)

-   直接从顶部菜单下-设计中的添加批注，会直接在画布上放置一个矩形区域，这个矩形的区域不会绑定到图元上

-   选中具体的一个或多个图元后，点击鼠标右键，选择添加批注，这样添加的批注会绑定到对应图元。注意：非连接标识、总线分支、器件属性无法添加批注

![图 2](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172125.gif)

添加批注时，必须要在右侧面板的对应批注条内输入内容，否则退出输入后，批注框会自动消失

![图 4](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172126.jpg)
...
![图 6](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172127.jpg)
...
![图 8](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172128.jpg)

在右侧面板点击某一条批注也会选中该批注条，画布中的批注框会居中显示

![图 11](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172129.jpg)

如果在右侧面板双击批注条，会选中画布上批注框，并且居中和适应画布大小，在未打开对应图页的情况下进行双击，还会自动打开到该图页

![图 12](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172130.jpg)

将鼠标悬浮在右侧面板某一条批注上时，对应批注以及画布上的批注框会高亮

![图 26](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172131.gif)

### 批注的回复和删除

将鼠标放到某一条批注内容上既可显示删除和回复的按钮，点击即可进行对应操作

![图 14](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172132.jpg)
...
![图 28](/storage/images/cn/schematic/design-add-annotation/design-add-annotation_20240621_172133.jpg)
