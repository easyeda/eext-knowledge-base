...
- 模型HF仓库更新，已重新从原始模型转换ONNX格式

## 1.9.1

### 优化

- 新增支持 WebGPU 加速，可在设置中选择自动、GPU 或 CPU。
- 默认模型拉取地址改为[🤗HuggingFace社区](https://huggingface.co/)，解决跨源资源请求问题。  
  注：若无法访问🤗HuggingFace社区，也可在设置中配置自定义镜像站点或通过本地导入模型文件
