...
导入 Markdown 文档构建知识库，提问时自动检索相关内容，通过 AI 模型生成回答。

- 默认通用模型：[Qwen2.5-0.5B-Instruct-ONNX](https://huggingface.co/JasonYANG170/Qwen2.5-0.5B-Instruct-ONNX)
- 默认向量模型：[bge-large-zh-v1.5-ONNX](https://huggingface.co/JasonYANG170/bge-large-zh-v1.5-ONNX)
...
- [Qwen2.5-0.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct) — 开源中英双语大语言模型
- [BAAI/bge-large-zh-v1.5](https://huggingface.co/BAAI/bge-large-zh-v1.5) — 开源中英双语嵌入模型
